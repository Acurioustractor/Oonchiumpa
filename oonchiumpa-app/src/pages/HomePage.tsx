...
export const HomePage: React.FC = () => {
  ...
  return (
    <>
      ...
      {/* Community Content Showcase - Show community storytelling system */}
      <ContentShowcase />

      {/* Partner Showcase - Show collaboration network */}
      <PartnerShowcase
        title="Our Partnership Network"
        subtitle="Working together to create lasting change in Aboriginal communities across Australia"
        maxPartners={8}
      ...
      <Section className="bg-gradient-to-br from-ochre-50 to-eucalyptus-50">
        <div className="text-center">
          ...
          <p className="text-lg text-earth-700 max-w-2xl mx-auto mb-8">
            Be part of a movement that honors the past, celebrates the present,
            and shapes the future through cultural connection and understanding.
          </p>
