...
exports.googlePhotos = exports.GooglePhotosIntegration = void 0;
...
class GooglePhotosIntegration {
     ...
     */
    async getPhotos(albumId, limit = 100) {
        try {
            let searchParams = {
     ...
     */
    async importPhotos(photos, options) {
        const importResults = [];
        for (const photo of photos) {
            try {
                ...
                const cloudinaryResult = await cloudinary_1.v2.uploader.upload(photoUrl, {
                ...
                // 3. Create thumbnail
                const thumbnailUrl = cloudinary_1.v2.url(cloudinaryResult.public_id, {
                    width: 400,
                    height: 300,
                    crop: 'fill',
                    gravity: 'center',
                ...
                if (options.autoAnalyze) {
                    try {
                        aiAnalysis = await aiOrchestrator_1.aiOrchestrator.analyzeMedia(cloudinaryResult.secure_url, 'image');
     ...
     */
    async linkToContent(mediaId, options) {
        try {
            if (options.storyId) {
     ...
     */
    async getPhotoSharingInfo(mediaItemId) {
        try {
     ...
     */
    async batchImportFromAlbum(albumId, options) {
...
exports.GooglePhotosIntegration = GooglePhotosIntegration;
// Export singleton instance
exports.googlePhotos = new GooglePhotosIntegration({
...
//# sourceMappingURL=googlePhotosIntegration.js.map