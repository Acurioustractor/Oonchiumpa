/**
 * AboutPage.tsx - INTEGRATION EXAMPLE
 *
 * This shows how to integrate real Oonchiumpa data into your About page
 *
 * KEY CHANGES FROM ORIGINAL:
 * 1. Removed placeholder teamMembers array (lines 46-69)
 * 2. Added LeadershipShowcase for Kristy & Tanya (replaces Team Section)
 * 3. Added StorytellerGrid for full team overview
 * 4. Kept all existing sections (Story, Mission/Values, Team Photos)
 *
 * WHAT YOU GET:
 * - Real photos from Supabase
 * - Real quotes from transcripts
 * - Real bios and cultural backgrounds
...
// ✨ NEW: Import real data components
...
export const AboutPage: React.FC = () => {
  ...
  return (
    <>
      ...
      {/* ✨ NEW: Leadership Section with Real Data - Kristy & Tanya */}
      <Section id="leadership">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-earth-700 max-w-2xl mx-auto">
            Traditional Owners and community advocates leading with cultural
            authority
          </p>
        </div>
        ...
        {/*
          ...
          - Fetches Kristy Bloomfield & Tanya Turner from Supabase
          - Shows real photos, bios, cultural backgrounds
          - Displays authentic quotes from their transcripts
          - showQuotes={true} = include quotes from transcripts
          - quotesPerPerson={3} = show 3 quotes per leader
        */}
        <LeadershipShowcase showQuotes={true} quotesPerPerson={3} />
      </Section>

      {/* ✨ NEW: Full Team Section with Real Data - All 8 Core Members */}
      <Section id="team" className="bg-earth-50">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-earth-700 max-w-2xl mx-auto">
            Guided by Elders, law students, and passionate community advocates
          </p>
        </div>

        {/*
          StorytellerGrid Component
          - Shows all 8 core team members:
            1. Kristy Bloomfield (Director)
            2. Tanya Turner (Legal Advocate)
            3. Aunty Bev & Uncle Terry (Elders)
            4. Adelaide Hayes (Law student)
            5. Aidan Harris (Law student)
            6. Chelsea Kenneally (Law student)
            7. Suzie Ma (Law student)
            8. Patricia Miller (Community member)
          - Real photos from profile_image_url
          - Real bios from cultural_background
          - Fetches from Supabase automatically
        */}
        <StorytellerGrid limit={8} showBio={true} columns={4} />
      </Section>

      {/* Team Photos Section - Kept as is */}
      <Section className="bg-white" id="team-photos">
 ...
 * WHAT CHANGED?
 *
 * 1. ❌ REMOVED: Placeholder teamMembers array (lines 46-69 in original)
 *    - Old hardcoded data: "image: null // Will load from team member database"
 *    - Now using real Supabase data instead
 *
 * 2. ✨ ADDED: LeadershipShowcase component (Section id="leadership")
 *    - Shows Kristy Bloomfield & Tanya Turner
 *    - Real photos from Supabase profile_image_url
 *    - Real quotes from AI-analyzed transcripts
 *    - Bios and cultural backgrounds
 *
 * 3. ✨ ADDED: StorytellerGrid component (Section id="team")
 *    - Shows all 8 core team members
 ...
 * HOW TO USE THIS:
 *
 * Option 1: Replace your entire AboutPage.tsx with this file
 * Option 2: Copy just the Leadership and Team sections
 * Option 3: Use as reference and integrate piece by piece
 *
 * TESTING:
 *
 * 1. Make sure .env has Supabase credentials:
 ...
 *
 * 4. Scroll to "Our Leadership" - should see Kristy & Tanya with quotes
 *
 * 5. Scroll to "Our Team" - should see all 8 core members in grid
 *
 * TROUBLESHOOTING:
 *
 * - "No leadership showing" → Check browser console for Supabase errors
 * - "No quotes showing" → Verify transcripts exist in database
 * - "No photos showing" → Check profile_image_url in Supabase profiles table
 * - "Component not found" → Make sure LeadershipShowcase.tsx exists in components/
 */
